...
const registerWebViewElement = (window, WebViewElement) => {
  // By default just define the WebViewElement in current context.
  if (WebViewElement === null) {
    WebViewElement = require('@electron/internal/renderer/web-view/web-view-element')
  }

  // Define the custom element registration methods.
  Object.defineProperty(WebViewElement, 'observedAttributes', {
    get: () => {
      return [
  ...
  WebViewElement.prototype.connectedCallback = function () {
  ...
  WebViewElement.prototype.attributeChangedCallback = function (name, oldValue, newValue) {
    const internal = v8Util.getHiddenValue(this, 'internal')
    if (internal) {
  ...
  WebViewElement.prototype.disconnectedCallback = function () {
    const internal = v8Util.getHiddenValue(this, 'internal')
    if (!internal) {
      return
    }
  ...
  WebViewElement.prototype.initialize = function () {
...
const setupWebView = (window, WebViewElement = null) => {
  ...
  window.addEventListener('readystatechange', function listener (event) {
    ...
    registerWebViewElement(window, WebViewElement)
